...
//    private ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initialization();
        String sha1 = sHA1(this.getApplicationContext());
        Log.d("sha1", sha1);
...
//                city = citySelected[1];
    ...
    private void getForcastWeather() {
        String url1 = "https://restapi.amap.com/v3/weather/weatherInfo?city=CITY&key=3ae9d9cbfc7d03a06a638f2e35f2eee1&extensions=all";
...
//                                        sb3.append("晚上:").append(fc3.getNightwind()).append("风").append(fc3.getNightpower()).append("级");
    ...
    private void getRealWeather() {
        String realUrl = "https://restapi.amap.com/v3/weather/weatherInfo?city=CITY&key=3ae9d9cbfc7d03a06a638f2e35f2eee1&extensions=base";
